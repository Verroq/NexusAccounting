...
FILES = [
    ...
    'galaxy-fetch-hook.js', 'galaxy-fields.js', 'empire-view.js', 'guide-view.js', 'logistics-view.js', 'upgrade-queue.js', 'building-upgrade.js', 'tech-upgrade.js', 'ship-upgrade.js', 'ingame-tabs.js',
