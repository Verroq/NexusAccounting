  ...
  "resourceSnapshots": [
    {
      ...
      "locationId": 654,
      "revision": 398,
      "serverNow": "2026-08-26T09:19:52.697Z",
      "resourcesUpdatedAt": "2026-08-09T18:18:34.713Z",
      "resources": {
        "ore": 17959,
        "silicates": 19730,
...
- Both arrays are populated on the sweep account (5 outposts).

## Live Verification

- Verified 2026-08-26 on `s0`: `GET /api/outposts` -> `200`.
- Example above is a real response with every array truncated to its first item.
- Live array sizes at capture time: `outposts`=5, `outposts[].buildings`=4, `resourceSnapshots`=5.
